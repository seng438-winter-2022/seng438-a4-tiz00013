...
Mutation testing is important because the new test cases would help find more defects that exist in the program. This can improve the test suite and the quality of the program is improved and this is achieved by inserting mutants into the program and our newly designed test cases should be able to detect the faults that are present in the system. Furthermore, this method of testing is useful for getting a stronger coverage by testing certain parts of the code.
